...
const ReturnDetails = ({ route, navigation }) => {
  const { returnDetails } = route.params; // Access the passed returnDetails object

  const navigateToRefundInformation = () => {
    navigation.navigate('RefundInformation', { returnDetails });
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.returnItem}>
        ...
        <View style={{padding: 10}}>
          ...
          <View style={{flexDirection: "row", justifyContent: "space-around", gap: 10, marginBottom: 10}}>
            <TouchableOpacity style={styles.contactButton} onPress={() => navigation.navigate('ContactBuyer')}>
