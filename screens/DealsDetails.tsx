  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Deals Details</Text>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.flashDealContainer}>
          ...
          <View style={styles.summary}>
            <Text style={styles.orderDetail}>Stock</Text>
            <Text style={styles.orderDetailValue}>192</Text>
          </View>
          <View style={styles.summary}>
            <Text style={styles.orderDetail}>Deal fee</Text>
          ...
          <View style={styles.summary}>
            <Text style={styles.orderDetail}>Unit Sold</Text>
            <Text style={styles.orderDetailValue}>7</Text>
          </View>
          <View style={styles.summary}>
            <Text style={styles.orderDetail}>Views</Text>
            <Text style={styles.orderDetailValue}>2,134</Text>
          </View>
          <View style={styles.summary}>
            <Text style={styles.orderDetail}>Conversion rate</Text>
