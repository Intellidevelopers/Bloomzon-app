...
const ResetPassword = ({ navigation }) => {
  ...
  //     } else {
  //       navigation.navigate('/Success'); // Redirect to success page or show a success message
  //     }
  //   } catch (error) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.loginButton} onPress={() => navigation.navigate('Success')}>
