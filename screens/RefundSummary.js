...
const RefundSummary = () => {
    ...
    const { amountToRefund, taxOnAmountToRefund, reason } = route.params || {};
  
    // Handle parsing for numeric values
    const refundAmount = parseFloat(amountToRefund) || 0;
    const tax = parseFloat(taxOnAmountToRefund) || 0;
