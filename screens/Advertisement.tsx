  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-evenly", marginTop: 20 }}>
            <TouchableOpacity style={styles.tabsContainer} onPress={() => navigation.navigate('/DealsScreen')}>
              <View style={styles.tabContent}>
                <MaterialCommunityIcons name='brightness-percent' size={30} color='#41ccc7' style={{ marginBottom: 10 }} />
            ...
            <TouchableOpacity style={styles.tabsContainer}>
              <View style={styles.tabContent}>
                <FontAwesome6 name='lemon' size={30} color='#41ccc7' style={{ marginBottom: 10 }} />
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-evenly", marginTop: 20 }}>
            <TouchableOpacity style={styles.tabsContainer}>
              <View style={styles.tabContent}>
                <Text style={{fontFamily: "Bold", color: "#41ccc7", fontSize: 20}}>ELITE</Text>
            ...
            <TouchableOpacity style={styles.tabsContainer}>
              <View style={styles.tabContent}>
                <Ionicons name='megaphone' size={30} color='#41ccc7' style={{ marginBottom: 10 }} />
