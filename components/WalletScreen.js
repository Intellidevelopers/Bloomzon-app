  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.requestPaymentButton} onPress={() => navigation.navigate('Request')}>
        ...
        {/* Options */}
        <TouchableOpacity style={[styles.optionContainer, styles.option1]} onPress={() => navigation.navigate('PaymentMethod')}>
          <View style={styles.optionIconContainer}>
            <MaterialCommunityIcons name='credit-card-check' size={18} color='#41ccc7' />
          </View>
          <Text style={styles.optionText}>Payment Methods</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionContainer}>
          <View style={styles.optionIconContainer}>
            <Entypo name='help-with-circle' size={24} color='#41ccc7' />
          </View>
